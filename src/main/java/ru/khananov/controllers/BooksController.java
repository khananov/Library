...
public class BooksController {
    ...
    @GetMapping()
    public String index(@RequestParam(name = "sort_by_year", required = false) boolean isSorting, Model model) {
        model.addAttribute("books", booksService.findAllSortedByYear(isSorting));
        return "book/index";
    }
