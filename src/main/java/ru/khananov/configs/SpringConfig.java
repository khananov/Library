...
@ComponentScan("ru.khananov")
@EnableTransactionManagement
@EnableJpaRepositories("ru.khananov.repositories")
@EnableWebMvc
public class SpringConfig implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(Objects.requireNonNull(environment.getProperty("connection.driver")));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.khananov.models");
